      ...
      <div className="container mx-auto px-6 relative z-10 max-w-6xl">
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-12 items-start">
          ...
          <div className="lg:w-1/2 flex flex-col gap-6 lg:mt-2">
            {/* Formal Notice Box - Hidden on Mobile, Yellow on Desktop */}
            <div className="hidden lg:block border-l-4 border-yellow-500 bg-yellow-50 p-3 rounded-sm w-fit">
            ...
            <div className="space-y-4">
              ...
              <p className="text-base text-slate-700 max-w-md leading-relaxed">
                {/* Mandatory text inline for mobile only */}
                <span className="font-semibold text-slate-900 lg:hidden">Mandatory Requirement: </span>
            ...
            {/* CTA Button & Disclaimer - DESKTOP ONLY (Hidden on Mobile) */}
          ...
          <div className="lg:w-1/2 w-full flex flex-col">
            <div className="bg-white border border-slate-300 border-t-4 border-t-blue-700 rounded-sm shadow-sm p-6 lg:p-8 w-full">
            ...
            {/* CTA Button & Disclaimer - MOBILE ONLY (Hidden on Desktop, placed below the box) */}
            <div className="lg:hidden w-full mt-6 flex flex-col">
              <Button
                asChild
                size="lg"
                className="h-12 w-full rounded-sm font-medium bg-blue-700 hover:bg-blue-800 text-white shadow-none transition-none text-base"
              >
