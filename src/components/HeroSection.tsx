...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-[85vh] flex items-center overflow-hidden bg-[#F8FAFC]">
      {/* ——— IMAGE POSITIONED ONLY ON THE RIGHT ——— */}
      <div className="absolute top-0 right-0 w-full lg:w-[45%] h-full z-0">
        ...
        />
        {/* Gradient overlay to blend the image into the white/light blue left side */}
        <div className="absolute inset-0 bg-gradient-to-b from-white/20 via-transparent to-white/20 lg:bg-gradient-to-r lg:from-[#F8FAFC] lg:via-transparent lg:to-transparent" />
      </div>

      <div className="container mx-auto px-6 relative z-10 max-w-6xl">
        <div className="grid lg:grid-cols-[1fr_0.8fr] gap-8 lg:gap-16 items-center">
          {/* ——— LEFT COLUMN: Clean & Official ——— */}
          <div className="flex flex-col space-y-4 lg:space-y-6 pt-4 lg:pt-0">
            <div className="flex items-center gap-2">
              {/* Yellow Mandatory Badge */}
              <span className="px-3 py-1.5 rounded-md bg-yellow-400 text-slate-900 text-[10px] font-black uppercase tracking-widest shadow-sm flex items-center gap-2">
            ...
            <div className="space-y-2 lg:space-y-3">
              ...
              <p className="text-sm md:text-base text-slate-500 max-w-md leading-relaxed font-medium">
                Fast digital registration for the mandatory Malaysia Arrival Card (MDAC) for all international visitors.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
              <Button
                asChild
                size="lg"
                className="w-full sm:w-auto h-14 px-12 rounded-2xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-lg shadow-xl shadow-blue-200 border-0 transition-all active:scale-95"
              >
          ...
          {/* ——— RIGHT COLUMN: Steps Card Over Image ——— */}
          <div className="relative pb-8 lg:pb-0">
            {/* The Glass Card */}
            <div className="relative bg-white/90 backdrop-blur-xl border border-white rounded-[2rem] p-6 lg:p-8 shadow-[0_20px_50px_rgba(0,0,0,0.1)]">
