      ...
      <div className="container mx-auto px-6 relative z-10 max-w-6xl">
        <div className="flex flex-col md:grid md:grid-cols-2 lg:grid-cols-[1.15fr_1fr] gap-5 md:gap-10 lg:gap-16 items-center">
          ...
          <div className="flex flex-col w-full">
            ...
            <h1
              className="text-3xl md:text-[2.25rem] lg:text-[3rem] font-extrabold leading-[1.12] mb-3 md:mb-5 tracking-[-0.02em]"
              style={{
                color: "#2D4A6F",
            ...
            {/* Mobile Description (Shorter & Tighter) */}
            <p className="block md:hidden text-[14px] leading-[1.5] mb-5 max-w-lg" style={{ color: "#8196AE" }}>
            ...
            <div className="mb-0 md:mb-8">
              <Button
                asChild
                size="lg"
                className="font-bold h-12 lg:h-13 px-6 lg:px-8 rounded-full transition-all duration-300 hover:translate-y-[-2px] hover:shadow-xl group text-[14px] lg:text-[15px] w-full md:w-auto"
                style={{
          ...
          <div className="w-full py-2 md:py-6 lg:py-10">
            <div
              className="rounded-[1.5rem] md:rounded-[2rem] p-4 md:p-5 lg:p-7"
              style={{
            ...
            >
              <div className="flex items-center justify-between mb-4 md:mb-5 lg:mb-6">
                <h3 className="font-bold text-[14px] lg:text-[16px]" style={{ color: "#3D5A80" }}>
                  How It Works
                </h3>
                <span
                  className="text-[9px] lg:text-[10px] px-2.5 py-1 md:px-3 md:py-1.5 rounded-full font-bold tracking-widest uppercase"
                  style={{
                    background: "#F8FAFC",
                    color: "#64748B",
                ...
                {steps.map((step, index) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <h4
                        className="font-bold text-[13px] lg:text-[14px] mb-0.5 transition-colors duration-200"
                        style={{ color: "#2D4A6F" }}
                      >
                        {step.title}
                      </h4>
                      <p
                        className="text-[11px] lg:text-[12px] leading-tight md:leading-snug"
                        style={{ color: "#8DA2B8" }}
                      >
                        {step.desc}
                      </p>
              ...
              {/* Alert / Notice */}
              <div
                className="flex items-start gap-2.5 md:gap-3 mt-4 md:mt-5 lg:mt-6 px-3 py-2.5 md:px-4 md:py-3 rounded-xl md:rounded-2xl"
                style={{
                  background: "#F8FAFF",
                  border: "1px solid #E2E8F0",
                }}
              >
                <Lightbulb className="w-3.5 h-3.5 md:w-4 md:h-4 flex-shrink-0 mt-0.5" style={{ color: "#3B82F6" }} />
                <p className="text-[10.5px] md:text-[11px] lg:text-[12px] leading-relaxed" style={{ color: "#64748B" }}>
            ...
            <p
              className="block md:hidden mt-3 text-[9.5px] leading-relaxed text-center px-2"
              style={{ color: "#94A3B8" }}
            >
              Disclaimer: We are an independent agency assisting travelers with their documentation. We are not legally
              affiliated with the Malaysian government.
