...
const HeroSection = () => {
  ...
  return (
    <section className="relative overflow-hidden min-h-[92vh] flex items-center py-6 md:py-10 bg-slate-50">
      {/* Subtle Government Background Pattern */}
      ...
      <div className="container mx-auto px-6 relative z-10 max-w-6xl">
        <div className="grid md:grid-cols-2 lg:grid-cols-[1.15fr_1fr] gap-10 items-center">
          {/* LEFT COLUMN */}
          ...
          {/* RIGHT COLUMN - Redesigned How It Works */}
          <div>
