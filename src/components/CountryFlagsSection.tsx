    ...
    return (
      <section className="py-16 bg-background font-quicksand">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-foreground mb-4">Eligible Nationalities</h2>
    ...
    <section className="py-16 bg-background font-quicksand">
      <div className="container mx-auto px-4">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-bold text-foreground mb-3">Eligible Nationalities</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Travelers from these countries are required to complete the MDAC before entering Malaysia.
          </p>
        </div>
        ...
        <div className="grid grid-cols-5 gap-3 max-w-5xl mx-auto">
          {displayedCountries.map((country, index) => (
            <Card
              key={index}
              className="p-3 hover:shadow-soft transition-all duration-300 cursor-pointer hover:scale-[1.02] border border-border bg-card rounded-xl"
            >
              <div className="flex items-center gap-3">
                <img
                  src={country.flag_url}
                  alt={`${country.country} flag`}
                  className="w-7 h-5 object-cover flex-shrink-0 rounded-sm"
                  loading="lazy"
                />
        ...
        {!showAll && countries.length > INITIAL_DISPLAY_COUNT && (
          <div className="text-center mt-8">
            <Button
              ...
              variant="outline"
              className="border border-primary text-primary hover:bg-primary hover:text-primary-foreground font-medium px-6 rounded-lg"
            >
