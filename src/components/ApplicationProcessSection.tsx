    ...
    <section className="py-20 bg-secondary">
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="text-center mb-14">
          <p className="text-xs uppercase tracking-widest text-accent font-semibold mb-2">The Concierge Flow</p>
          <h2 className="text-2xl md:text-3xl font-bold text-foreground">Application Process</h2>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {steps.map((s) => {
            const Icon = s.icon;
            return (
              <div key={s.step} className="bg-background rounded-xl p-6 border border-border hover:shadow-elegant transition-shadow">
        ...
        <div className="mt-10 text-center">
          <p className="inline-flex items-center gap-2 bg-accent/10 text-accent font-medium text-sm px-5 py-2.5 rounded-full border border-accent/20">
